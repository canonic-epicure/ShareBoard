...
//            this.drawTools.cursor.activate()
    ...
    methods : {
        ...
        setupBoard : function () {
            ...
            board.on('sketch', this.onElementSketch, this)
            board.on('put', this.onElementPut, this)
        },
        ...
        onElementSketch : function () {
            var params = Array.prototype.slice.call(arguments)
            
            params[ 0 ] = params[ 0 ].uuid
            
            this.channel.publish('/draw', params)
        },
        
        
        onElementPut : function () {
            var params = Array.prototype.slice.call(arguments)
