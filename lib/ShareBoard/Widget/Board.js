    ...
    methods : {
        ...
        onMutation : function (channel, instance, packet) {
            ...
            if (packet.at(0) instanceof Syncler.Vero.Mutation.Create) {
                ...
                this.onNewElement(this.board, instance)
                
            } else {
                
                this.onObjectMutate(channel, instance, packet)
            }
        },
        
        
        onNewElement : function (board, element) {
        ...
        onObjectMutate : function (channel, object, packet) {
